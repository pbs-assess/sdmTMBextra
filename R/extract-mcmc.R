...
#'   element of an [sdmTMB::sdmTMB()] model. E.g.,
...
#' posterior samples. The output can be passed to [sdmTMB::predict.sdmTMB()] to
#' make fully Bayesian predictions. See the `mcmc_samples` argument in
